...
##  ("nothing", "nothing"),
  ...
  ("tutorial_map2","You are now viewing the overland map. Left-click on the map to move your party to that location, enter the selected town, or pursue the selected party. Time will pause on the overland map if your party is not moving, waiting or resting. To wait anywhere simply press and hold down the space bar."),
...
#npc16 = klethi
  ...
  ("npc18_intro", "Greetings, I am known as Porziano."),
  ("npc19_intro", "Greetings, I am known as Boadicea."),
  ("npc20_intro", "Greetings, I am known as Karn."),
  ("npc21_intro", "Greetings, I am known as Ostanes."),
  ("npc22_intro", "Greetings, I am known as Agustina."),
  ("npc23_intro", "My, my {lord/lady}! It is you! The rightful ruler of Calradia!."),
  ("npc24_intro", "Hail and well met, I am Xin Tian."),
  #("npc25_intro", "Hail and well met, I am Bhagwandas."),
  ...
  ("npc17_intro_response_1", "The legendary Heavenly Knight?"),
  ("npc18_intro_response_1", "Tell me about yourself Porziano."),
  ("npc19_intro_response_1", "Tell me about yourself Boadicea."),
  ("npc20_intro_response_1", "Tell me about yourself Karn."),
  ("npc21_intro_response_1", "Tell me about yourself Ostanes."),
  ("npc22_intro_response_1", "Tell me about yourself Agustina."),
  ("npc23_intro_response_1", "What on earth are you going on about?."),
  ("npc24_intro_response_1", "Tell me about yourself Xin Tian."),
  #("npc25_intro_response_1", "Tell me about yourself Bhagwandas."),
  ...
  ("npc17_intro_response_2", "Shut up, old man."),
  ("npc18_intro_response_2", "Not interested."),
  ("npc19_intro_response_2", "Not interested."),
  ("npc20_intro_response_2", "Not interested."),
  ("npc21_intro_response_2", "Not interested."),
  ("npc22_intro_response_2", "Not interested."),
  ("npc23_intro_response_2", "Get away from me you loon!"),
  ("npc24_intro_response_2", "Not interested."),
  #("npc25_intro_response_2", "Not interested."),
...
#backstory intro
  ...
  ("npc17_backstory_a", "I come from a far away war-torn land..."),
  ("npc18_backstory_a", "I am the only son of a duke. I was still a child when my father died, and a rival duke of his awarded my father's lands to others. When I did not relinquish my claim to my inheritance I was returned control of half my lands."),
  ("npc19_backstory_a", "I was the wife of a tribal elder. When he died, his will stated that the kingdom would be jointly ruled by our daughters and the neighboring kingdom."),
  ("npc20_backstory_a", "I am a wandering knight. My father was a king."),
  ("npc21_backstory_a", "Hmm, well you wish to know more about me eh?"),
  ("npc22_backstory_a", "I came to Calradia seeking fame and fortune."),
  ("npc23_backstory_a", "Well, {sir/maam}, I was a mere farmer's daughter until just a few months ago. "),
  ("npc24_backstory_a", "I came to Calradia seeking fame and fortune."),
  #("npc25_backstory_a", "I came to Calradia seeking fame and fortune."),
...
#backstory main body
  ...
  ("npc17_backstory_b", "After much strife, I left for a place with better opritunities for one such as myself, so I came to Calradia."),
  ("npc18_backstory_b", "After participating in a successful crusade, I petitioned the emperor and he returned all my father's lands to me. I remained faithful in service to my emperor throughout many campaigns, being a key factor for victory due to my skilled leadership of the knights."),
  ("npc19_backstory_b", "However the neighboring king ignored the will and anexed our tribe. I was flogged and my daughters were raped. So I rallied my people and a neighboring tribe and destroyed three of their cities and routed a legion."),
  ("npc20_backstory_b", "I've come to Calradia in search of my father's killer."),
  ("npc21_backstory_b", "I have been called many things in my day, warlock, wizard, mage, alchemist, necromancer, diviner... among others. But what I am is a student of the world."),
  ("npc22_backstory_b", "So I wandered around, and here I met you."),
  ("npc23_backstory_b", "But when I was out in the fields, three angels came to me and showed me your image, they said I had to seek you out and assist you in anyway I could."),
  ("npc24_backstory_b", "So I wandered around, and here I met you."),
  #("npc25_backstory_b", "So I wandered around, and here I met you."),
...
#backstory recruit pitch
  ...
  ("npc17_backstory_c", "If you are in need of a true hero, I am able."),
  ("npc18_backstory_c", "However, after many successive battles, I had to refuse to aid my emperor in an invasion to protect my own borders. The invasion was a failure, and he blamed me for it. The emperor stripped me of my lands and declared me an outlaw, so I sought asylum here in Calradia."),
  ("npc19_backstory_c", "But our enemy regrouped, and even though we outnumbered them, after a long struggle we lost. And so I fled to Calradia."),
  ("npc20_backstory_c", "My father was killed by his brother, a renegade count."),
  ("npc21_backstory_c", "During my time here I have become the foremost expert on the human body, and all it's workings, which, hehe, leads the peasants to think I've sold my soul to a devil. I've come to Calradia because, do to the constant wars, there are plenty of corpses left about to study."),
  ("npc22_backstory_c", "And thats it."),
  ("npc23_backstory_c", "And, and, then you, you walked into this very tavern! Where I had just happen to enter! Our meeting is fate!"),
  ("npc24_backstory_c", "And thats it."),
  #("npc25_backstory_c", "And thats it."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc17_backstory_later", "Good day to you, {sir/maam}."),
  ("npc18_backstory_later", "Good day to you, {sir/maam}."),
  ("npc19_backstory_later", "Good day to you, {sir/maam}."),
  ("npc20_backstory_later", "Good day to you, {sir/maam}."),
  ("npc21_backstory_later", "Good day to you, {sir/maam}."),
  ("npc22_backstory_later", "Good day to you, {sir/maam}."),
  ("npc23_backstory_later", "My, my {lord/lady}, you came back!"),
  ("npc24_backstory_later", "Good day to you, {sir/maam}."),
  #("npc25_backstory_later", "Good day to you, {sir/maam}."),
  ...
  ("npc17_backstory_response_1", "A hero like yourself would be a credit to my cause. Tell me more."),
  ("npc18_backstory_response_1", "I am in need of those capable to rule fiefs."),
  ("npc19_backstory_response_1", "I am in need of those capable to rule fiefs."),
  ("npc20_backstory_response_1", "I am in need of skillful warriors."),
  ("npc21_backstory_response_1", "I am in need of a skilled doctor."),
  ("npc22_backstory_response_1", "I am in need of those capable to rule fiefs."),
  ("npc23_backstory_response_1", "I am in need of those capable to rule fiefs."),
  ("npc24_backstory_response_1", "I am in need of a tactician."),
  #("npc25_backstory_response_1", "I am in need of a trader."),
  ...
  ("npc17_backstory_response_2", "You are too great for me."),
  ("npc18_backstory_response_2", "That was interesting, but I have to go."),
  ("npc19_backstory_response_2", "That was interesting, but I have to go."),
  ("npc20_backstory_response_2", "That was interesting, but I have to go."),
  ("npc21_backstory_response_2", "That was interesting, but I have to go."),
  ("npc22_backstory_response_2", "That was interesting, but I have to go."),
  ("npc23_backstory_response_2", "That was interesting, but I have to go."),
  ("npc24_backstory_response_2", "That was interesting, but I have to go."),
  #("npc25_backstory_response_2", "That was interesting, but I have to go."),
  ...
  ("npc17_signup", "Well, {sir/madame}, I am already well known as a legendary general, I have experience being the marshall of an army, and would be well suited to that task if you needed me."),
  ("npc18_signup", "I come from a well respected noble lineage, and posses a strong repertoire with the people."),
  ("npc19_signup", "{Sir/Madame}, I am strong warrior, and capable general."),
  ("npc20_signup", "{Sir/Madame}, I am skilled warrior and will serve you well on the battlefield, as long as we travel these lands."),
  ("npc21_signup", "Well {Sir/Madame}, I'd wager you will not find a more knowledgeable man in those regards anywhere else in Calradia, heh, perhaps the world."),
  ("npc22_signup", "I will join you if you want."),
  ("npc23_signup", "{Sir/Maam}, when the angels came to me, they said I would have the power of the heavens on my side as long as I was in your service."),
  ("npc24_signup", "I will join you if you want."),
  #("npc25_signup", "I will join you if you want."),
  ...
  ("npc17_signup_2", "I am undefeated in battle, one of the strongest, most experienced warriors in the land, the fate of the world could well rest on who I support."),
  ("npc18_signup_2", "I am an experienced commander of men, and have many successful battles under my belt. I would be a great decider in any battle in which I was a part of."),
  ("npc19_signup_2", "I was also very active supporting my husband when he was still alive, so I know a thing or two about ruling the people."),
  ("npc20_signup_2", "I am in search of a knight clad in black, he is the one who is responsible for my father's death. I have a feeling we'll run into him in our travels thru Calradia."),
  ("npc21_signup_2", "It would also be most advantageous for me to be able to study... freshly dead corpses, so I've been looking for an army I could sign up with."),
  ("npc22_signup_2", "So do you want me?"),
  ("npc23_signup_2", "And, uhh, I used to help my father, who was a part time tax collector, from time to time."),
  ("npc24_signup_2", "So do you want me?"),
  #("npc25_signup_2", "So do you want me?"),
  ...
  ("npc17_signup_response_1", "I would be honored to have the opritunity to work with you."),
  ("npc18_signup_response_1", "I could use someone of your experience."),
  ("npc19_signup_response_1", "I could use someone of your experience."),
  ("npc20_signup_response_1", "I could use someone of your strength."),
  ("npc21_signup_response_1", "I could use someone of your expertise."),
  ("npc22_signup_response_1", "I could use someone of your experience."),
  ("npc23_signup_response_1", "If what you say is true, then I will gladly accept the gift the heavens have given me in your service."),
  ("npc24_signup_response_1", "I could use someone of your expertise."),
  #("npc25_signup_response_1", "I could use someone of your expertise."),
...
#11
  ...
  ("npc17_signup_response_2", "I don't need your help."),
  ("npc18_signup_response_2", "I'll be fine without you."),
  ("npc19_signup_response_2", "I'll be fine without you."),
  ("npc20_signup_response_2", "I'll be fine without you."),
  ("npc21_signup_response_2", "I'll be fine without you."),
  ("npc22_signup_response_2", "I'll be fine without you."),
  ("npc23_signup_response_2", "You stay away from me!"),
  ("npc24_signup_response_2", "I'll be fine without you."),
  #("npc25_signup_response_2", "I'll be fine without you."),
  ...
  ("npc17_payment", "My service doesn't come cheap, I'll need {reg3} denars."),
  ("npc18_payment", "My service could be yours, for the price of {reg3} denars."),
  ("npc19_payment", "{reg3} denars. And I will serve you."),
  ("npc20_payment", "{reg3} denars. And I will serve you."),
  ("npc21_payment", "However my services won't come cheap. I'll need a signing fee of {reg3} denars, and I will cost you around 200 denars a week to stay in your employ."),
  ("npc22_payment", "I will need {reg3} denars."),
  ("npc23_payment", "If you were to donate {reg3} denars to the church, I will join you imediately."),
  ("npc24_payment", "I will need {reg3} denars."),
  #("npc25_payment", "I will need {reg3} denars."),
  ...
  ("npc17_payment_response", "All right, here's {reg3} denars for you. Let us conquer these lands."),


  ("npc18_payment_response", "But of course, here is {reg3} denars."),
  ("npc19_payment_response", "But of course, here is {reg3} denars."),
  ("npc20_payment_response", "But of course, here is {reg3} denars."),
  ("npc21_payment_response", "But of course, here is {reg3} denars, and I'll have to recheck the armies budget."),
  ("npc22_payment_response", "But of course, here is {reg3} denars."),
  ("npc23_payment_response", "But of course, here is {reg3} denars."),
  ("npc24_payment_response", "But of course, here is {reg3} denars, and I'll have to recheck the armies budget."),
  #("npc25_payment_response", "But of course, here is {reg3} denars, and I'll have to recheck the armies budget."),
  ...
  ("npc17_morality_speech", "Captain. I don't like to {s21}. So many throats left uncut, and so many purses left unexplored..."),
  ("npc18_morality_speech", "I dislike when you do {s21}."),
  ("npc19_morality_speech", "I dislike when you do {s21}."),
  ("npc20_morality_speech", "I dislike when you do {s21}."),
  ("npc21_morality_speech", "I dislike when you do {s21}."),
  ("npc22_morality_speech", "I dislike when you do {s21}."),
  ("npc23_morality_speech", "I dislike when you do {s21}."),
  ("npc24_morality_speech", "I dislike when you do {s21}."),
  #("npc25_morality_speech", "I dislike when you do {s21}."),
  ...
  ("npc17_2ary_morality_speech", "Captain -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),
  ("npc18_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  ("npc19_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  ("npc20_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  ("npc21_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  ("npc22_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  ("npc23_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  ("npc24_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  #("npc25_2ary_morality_speech", "Doing {s21} doesn't bother me {sir/madame}."),
  ...
  ("npc17_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. He makes strange scrawlings in the dirt, and mutters to himself."),
  ("npc18_personalityclash_speech", "I just don't like that {s11}."),
  ("npc19_personalityclash_speech", "I just don't like that {s11}."),
  ("npc20_personalityclash_speech", "That's him! {s11}! He is responsible for my father's death!"),
  ("npc21_personalityclash_speech", "I just don't like that {s11}."),
  ("npc22_personalityclash_speech", "I just don't like that {s11}."),
  ("npc23_personalityclash_speech", "I just don't like that {s11}."),
  ("npc24_personalityclash_speech", "I just don't like that {s11}."),
  #("npc25_personalityclash_speech", "I just don't like that {s11}."),
  ...
  ("npc17_personalityclash_speech_b", "Fearing witchcraft, I asked him about it, and he told me that a chit of a girl like myself should mind her own business. So I had a look in his baggage, and found strange plans and diagrams. I think he's a sorceror, {sir/madame}, and if I catch him trying to hex me he'll have a knife in his throat."),
  ("npc18_personalityclash_speech_b", "I can't agree with the way they do things."),
  ("npc19_personalityclash_speech_b", "I can't agree with the way they do things."),
  ("npc20_personalityclash_speech_b", "Now that I know where he is, I can finnaly settle things with him..."),
  ("npc21_personalityclash_speech_b", "I can't agree with the way they do things."),
  ("npc22_personalityclash_speech_b", "I can't agree with the way they do things."),
  ("npc23_personalityclash_speech_b", "I can't agree with the way they do things."),
  ("npc24_personalityclash_speech_b", "I can't agree with the way they do things."),
  #("npc25_personalityclash_speech_b", "I can't agree with the way they do things."),
...
### set off by behavior after victorious battle
  ...
  ("npc18_personalityclash2_speech", "That {s11}..."),
  ("npc19_personalityclash2_speech", "That {s11}..."),
  ("npc20_personalityclash2_speech", "{s11}... I was keeping an eye on him on the battlefield, he fights like a savage."),
  ("npc21_personalityclash2_speech", "That {s11}..."),
  ("npc22_personalityclash2_speech", "That {s11}..."),
  ("npc23_personalityclash2_speech", "That {s11}..."),
  ("npc24_personalityclash2_speech", "That {s11}..."),
  #("npc25_personalityclash2_speech", "That {s11}..."),
  ...
  ("npc18_personalityclash2_speech_b", "I can't stand watching them fight."), #klethi - borcha
  ("npc19_personalityclash2_speech_b", "I can't stand watching them fight."), #klethi - borcha
  ("npc20_personalityclash2_speech_b", "I don't know how you can keep him around."), #klethi - borcha
  ("npc21_personalityclash2_speech_b", "I can't stand watching them fight."), #klethi - borcha
  ("npc22_personalityclash2_speech_b", "I can't stand watching them fight."), #klethi - borcha
  ("npc23_personalityclash2_speech_b", "I can't stand watching them fight."), #klethi - borcha
  ("npc24_personalityclash2_speech_b", "I can't stand watching them fight."), #klethi - borcha
  #("npc25_personalityclash2_speech_b", "I can't stand watching them fight."), #klethi - borcha
  ...
  ("npc18_personalitymatch_speech", "Say I really feel a close relationship with {s11}..."),
  ("npc19_personalitymatch_speech", "Say I really feel a close relationship with {s11}..."),
  ("npc20_personalitymatch_speech", "I confronted {s11}... and I've learned something..."),
  ("npc21_personalitymatch_speech", "Hmm... that {s11} fellow... he is quite the practical one isn't he. I'd say he would make a good appretince, once all this Calradia business is over."),
  ("npc22_personalitymatch_speech", "Say I really feel a close relationship with {s11}..."),
  ("npc23_personalitymatch_speech", "Say I really feel a close relationship with {s11}..."),
  ("npc24_personalitymatch_speech", "Say I really feel a close relationship with {s11}..."),
  #("npc25_personalitymatch_speech", "Say I really feel a close relationship with {s11}..."),
  ...
  ("npc18_personalitymatch_speech_b", "She's a woman after my own heart."),
  ("npc19_personalitymatch_speech_b", "He's a man after my own heart."),
  ("npc20_personalitymatch_speech_b", "It seems I was wrong, someone else was responsible for our fathers' deaths. Once we are done here in Calradia, my cousin and I have promissed to return to our home, and find the true culprit behind their deaths."),
  ("npc21_personalitymatch_speech_b", "I do hope that {sir/madame} will keep him around, I do have plans to pass on my knowledge someday."),
  ("npc22_personalitymatch_speech_b", "He's a man after my own heart."),
  ("npc23_personalitymatch_speech_b", "He's a man after my own heart."),
  ("npc24_personalitymatch_speech_b", "We get along really well."),
  #("npc25_personalitymatch_speech_b", "We get along really well."),
  ...
  ("npc17_retirement_speech", "I've had good times in this company, and I've found myself a pretty trinket or two on the battlefield, but right now it isn't working out. I'm leaving you to go offer my talents to someone else."),
  ("npc18_retirement_speech", "I've grown tired of serving under you."),
  ("npc19_retirement_speech", "I've grown tired of serving under you."),
  ("npc20_retirement_speech", "I've grown tired of serving under you."),
  ("npc21_retirement_speech", "I've grown tired of serving under you."),
  ("npc22_retirement_speech", "I've grown tired of serving under you."),
  ("npc23_retirement_speech", "I've grown tired of serving under you."),
  ("npc24_retirement_speech", "I've grown tired of serving under you."),
  #("npc25_retirement_speech", "I've grown tired of serving under you."),
  ...
  ("npc17_rehire_speech", "Captain! They say that you've done well for yourself since we last met. I'll come out and admit that I cursed your name when we parted ways, but thinking back on it you weren't all that bad. All these lords, they're glad enough to send me on little side errands, but they don't much care to have me in their main battle-line. Apparently I spook the men. I've heard it muttered that I'm a witch, or that I eat men's hearts after killing them, or other rot. Not that I mind stabbing a man while he's asleep, but it's a lot more gratifying when he's awake and kicking. So I thought I'd try to find you again, see if you'll take me on."),
  ("npc18_rehire_speech", "After traveling for a while, I realised my place is with you."),
  ("npc19_rehire_speech", "After traveling for a while, I realised my place is with you."),
  ("npc20_rehire_speech", "After traveling for a while, I realised my place is with you."),
  ("npc21_rehire_speech", "After traveling for a while, I realised my place is with you."),
  ("npc22_rehire_speech", "After traveling for a while, I realised my place is with you."),
  ("npc23_rehire_speech", "After traveling for a while, I realised my place is with you."),
  ("npc24_rehire_speech", "After traveling for a while, I realised my place is with you."),
  #("npc25_rehire_speech", "After traveling for a while, I realised my place is with you."),
...
#local color strings
  ...
  ("npc17_home_intro", "Aye, captain, do you see those? Those are hare tracks in the snow. We must be getting near to my birthplace."),
  ("npc18_home_intro", "This reminds me of my home."),
  ("npc19_home_intro", "This reminds me of my home."),
  ("npc20_home_intro", "This reminds me of my home."),
  ("npc21_home_intro", "This reminds me of my home."),
  ("npc22_home_intro", "This reminds me of my home."),
  ("npc23_home_intro", "This reminds me of my home."),
  ("npc24_home_intro", "This reminds me of my home."),
  #("npc25_home_intro", "This reminds me of my home."),
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc17_home_description", "The snows in these valleys don't melt until late in the year, and the land is hard to plough. You can grow a bit of barley, but not much else. But there's wealth here in the woods: deer, rabbit and lynx, meat and furs, and the mountains have iron, and traders would ship enough saltfish up the river from the coast to keep the people fed for the winter."),
  ("npc18_home_description", "Being here makes me feel nostalgic."),
  ("npc19_home_description", "Being here makes me feel nostalgic."),
  ("npc20_home_description", "Being here makes me feel nostalgic."),
  ("npc21_home_description", "Being here makes me feel nostalgic."),
  ("npc22_home_description", "Being here makes me feel nostalgic."),
  ("npc23_home_description", "Being here makes me feel nostalgic."),
  ("npc24_home_description", "Being here makes me feel nostalgic."),
  #("npc25_home_description", "Being here makes me feel nostalgic."),
  ...
  ("npc17_home_description_2", "Still, it was a thin living, and there were always too many mouths around to feed. The Vaegir king and the Khergit khan don't make life any easier for us, squeezing for tax money the villages they control, and raiding for plunder the villages they don't. Of course, I can't say I'd do any differently do the same if I had a castle and an army all of my own. The mighty do whatever they can, and the humble do whatever they must."),
  ("npc18_home_description_2", "*sigh*"),
  ("npc19_home_description_2", "*sigh*"),
  ("npc20_home_description_2", "*sigh*"),
  ("npc21_home_description_2", "*sigh*"),
  ("npc22_home_description_2", "*sigh*"),
  ("npc23_home_description_2", "*sigh*"),
  ("npc24_home_description_2", "*sigh*"),
  #("npc25_home_description_2", "*sigh*"),
  ...
  ("npc17_home_recap", "Why, captain, I was born in Uslum village, but my mother lost her land to a scheming relative and had to put herself in bond to a nearby lord."),
  ("npc18_home_recap", "I am from a place you probably haven't heard of."),
  ("npc19_home_recap", "I am from a place you probably haven't heard of."),
  ("npc20_home_recap", "I am from a place you probably haven't heard of."),
  ("npc21_home_recap", "I am from a place you probably haven't heard of."),
  ("npc22_home_recap", "I am from a place you probably haven't heard of."),
  ("npc23_home_recap", "I am from a place you probably haven't heard of."),
  ("npc24_home_recap", "I am from a place you probably haven't heard of."),
  #("npc25_home_recap", "I am from a place you probably haven't heard of."),
  ...
  ("npc17_honorific", "{Sir/Lady} {playername}"), #balbanes
  ("npc18_honorific", "{Sir/Lady} {playername}"), #balbanes
  ("npc19_honorific", "{Sir/Lady} {playername}"), #balbanes
  ("npc20_honorific", "{Sir/Lady} {playername}"), #balbanes
  ("npc21_honorific", "{Sir/Lady} {playername}"), #balbanes
  ("npc22_honorific", "{Sir/Lady} {playername}"), #balbanes
  ("npc23_honorific", "{Sir/Lady} {playername}"), #balbanes
  ("npc24_honorific", "{Sir/Lady} {playername}"), #balbanes
  #("npc25_honorific", "{Sir/Lady} {playername}"), #balbanes
  ...
  ("npc17_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ("npc18_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ("npc19_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ("npc20_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ("npc21_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ("npc22_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ("npc23_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ("npc24_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  #("npc25_kingsupport_1", "I would be glad to use my influence to support your claim to be the rightful {king/queen} of Calradia."), #klethi
  ...
  ("npc17_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ("npc18_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ("npc19_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ("npc20_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ("npc21_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ("npc22_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ("npc23_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ("npc24_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  #("npc25_kingsupport_2", "I will spread word about how my {lord/lady} should be ruler to all in the land."), #klethi
  ...
  ("npc17_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc18_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc19_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc20_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc21_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc22_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc23_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc24_kingsupport_2a", "Interesting... Please continue"), #klethi
  #("npc25_kingsupport_2a", "Interesting... Please continue"), #klethi
  ...
  ("npc14_kingsupport_2b", "Actually, I was looking forward to a bit of rest after becoming king..."), #lazalit
  ...
  ("npc17_kingsupport_2b", "No thanks."), #klethi
  ("npc18_kingsupport_2b", "No thanks."), #klethi
  ("npc19_kingsupport_2b", "No thanks."), #klethi
  ("npc20_kingsupport_2b", "No thanks."), #klethi
  ("npc21_kingsupport_2b", "No thanks."), #klethi
  ("npc22_kingsupport_2b", "No thanks."), #klethi
  ("npc23_kingsupport_2b", "No thanks."), #klethi
  ("npc24_kingsupport_2b", "No thanks."), #klethi
  #("npc25_kingsupport_2b", "No thanks."), #klethi
  ...
  ("npc17_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ("npc18_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ("npc19_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ("npc20_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ("npc21_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ("npc22_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ("npc23_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ("npc24_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  #("npc25_kingsupport_3", "With your permission I shall go spread word of your right to be {king/queen}."), #klethi
  ...
  ("npc18_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
  ("npc19_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
  ("npc20_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
  ("npc21_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
  ("npc22_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
  ("npc23_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
  ("npc24_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
  #("npc25_kingsupport_objection", "I don't support your decision to send them off to spread support."), #klethi
...
#
  ...
  ("npc17_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ("npc18_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ("npc19_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ("npc20_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ("npc21_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ("npc22_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ("npc23_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ("npc24_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  #("npc25_intel_mission", "I could go to {s17}, to gather information about {s18}."), #klethi
  ...
  ("npc17_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ("npc18_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ("npc19_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ("npc20_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ("npc21_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ("npc22_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ("npc23_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ("npc24_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  #("npc25_fief_acceptance", "It would be my honor to serve you by governing {s17} for you {sire/my lady}."), #klethi  
  ...
  ("npc17_woman_to_woman", "{!}."), #klethi
  ("npc18_woman_to_woman", "{!}."), #artimenner
  ("npc19_woman_to_woman", "Lady {playername}, as a woman in a man's world myself, I too understand how hard it is too become renowned, but I must say your doing an amazing job."), #artimenner
  ("npc20_woman_to_woman", "{!}."), #artimenner
  ("npc21_woman_to_woman", "{!}."), #artimenner
  ("npc22_woman_to_woman", "Lady {playername}, as a woman in a man's world myself, I too understand how hard it is too become renowned, but I must say your doing an amazing job."), #artimenner
  ("npc23_woman_to_woman", "My lady {playername}, I just want say... that... umm... I... I... I... really appreciate... uh... like... uh... serving underneath you... and umm... thats all..."), #artimenner
  ("npc24_woman_to_woman", "Lady {playername}, as a woman in a man's world myself, I too understand how hard it is too become renowned, but I must say your doing an amazing job."), #artimenner
  #("npc25_woman_to_woman", "Lady {playername}, as a woman in a man's world myself, I too understand how hard it is too become renowned, but I must say your doing an amazing job."), #artimenner
  ...
  ("npc17_turn_against", "Hello, Captain! So, I guess we're enemies! One small word of warning if we end up fighting each other -- once the rage of battle hits me, I can't always account for my actions. Just know that whatever I do, it's not personal. Maybe if we both walk away from this, we can meet once more as friends?"), #klethi
  ("npc18_turn_against", "So we meet again, very well, I will have you taste my blade!"), #klethi
  ("npc19_turn_against", "Wha! I thought you were someone I could rely on {playername}."), #klethi
  ("npc20_turn_against", "Could it be? {playername} are you responsible for my father's death?"), #klethi
  ("npc21_turn_against", "Uh oh, I'm not much of a fighter, go easy on me {playername}."), #klethi
  ("npc22_turn_against", "Wha! I thought you were someone I could rely on {playername}."), #klethi
  ("npc23_turn_against", "Wha! I thought you were someone I could rely on {playername}."), #klethi
  ("npc24_turn_against", "Wha! I thought you were someone I could rely on {playername}."), #klethi
  #("npc25_turn_against", "Wha! I thought you were someone I could rely on {playername}."), #klethi
...
#courtship
  ...
  ("kingdom_1_adjective",                     "France"),
  ("kingdom_2_adjective",                     "Polish"),
  ("kingdom_3_adjective",                     "Golden_Horde"),
  ("kingdom_4_adjective",                     "England"),
  ("kingdom_5_adjective",                     "Italy"),
  ("kingdom_6_adjective",                     "Mamluk"),
  ("kingdom_7_adjective",                     "Holy_Roman_Empire"),
  ("kingdom_8_adjective",                     "Hungary"),
  ("kingdom_9_adjective",                     "Ottoman"),
  ("kingdom_10_adjective",                     "Nord"),
  ("kingdom_11_adjective",                     "Spain"),
  ("kingdom_12_adjective",                     "Moors"),
  ("kingdom_13_adjective",                     "order"),
  ("kingdom_14_adjective",                     "Moscow"),
...
#multiplayer game type names
  ...
  ("the_s5_is_ruled_by_s6_it_occupies_s8_its_vassals_are_s10__s21", "The {s5} is ruled by {s6}.^It occupies {s8}.^Its vassals are {s10}.^^its domestic policy^{s11}^{s12}^{s13}^{s14}^^{s21}"),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_king_title_7", "King {s0}"),
  ("faction_king_title_8", "King {s0}"),
  ("faction_king_title_9", "Sultan {s0}"),
  ("faction_king_title_10", "King {s0}"),
  ("faction_king_title_11", "King {s0}"),
  ("faction_king_title_12", "Sultan {s0}"),
  ("faction_king_title_13", "King {s0}"),
  ("faction_king_title_14", "King {s0}"),
  ## CC
  ...
  ("faction_title_male_7", "Count {s0}"),
  ("faction_title_male_8", "Boyar {s0}"),
  ("faction_title_male_9", "{s0} Noyan"),
  ("faction_title_male_10", "Jarl {s0}"),
  ("faction_title_male_11", "Count {s0}"),
  ("faction_title_male_12", "Emir {s0}"),
  ("faction_title_male_13", "Count {s0}"),
  ("faction_title_male_14", "Boyar {s0}"),
  ...
  ("faction_title_female_7", "Countess {s0}"),
  ("faction_title_female_8", "Boyarina {s0}"),
  ("faction_title_female_9", "{s0} Hatun"),
  ("faction_title_female_10", "Grevinne {s0}"),
  ("faction_title_female_11", "Countess {s0}"),
  ("faction_title_female_12", "Sayeda {s0}"),
  ("faction_title_female_13", "Sayeda {s0}"),
  ("faction_title_female_14", "Boyarina {s0}"),
  ("name_kingdom_text", "What will be the name of your kingdom?"),
  ("default_kingdom_name", "{s0}'s Kingdom"),

  ("reputation_type_1", "martial {s1}"),
  ("reputation_type_2", "bad-tempered {s1}"),
  ("reputation_type_3", "pitiless {s1}"),
  ("reputation_type_4", "cunning {s1}"),
  ("reputation_type_5", "sadistic {s1}"),
  ("reputation_type_6", "good-natured {s1}"),
  ("reputation_type_7", "upstanding {s1}"),
  ("reputation_type_8", "roguish {s1}"),
  ("reputation_type_9", "benevolent {s1}"),
  ("reputation_type_10", "mercantile {s1}"),
  ...
  ("bandit_hideout_success_2", "With their retreat cut off, the {s4} fall one by one to your determined attack. Their hideout, and their ill-gotten gains, as now yours."),
...
("the_coast", "the coast"),
  ...
  ("under_sequestration_2", "Under sequestration, lose {reg0} denars."),
...
## CC
  ...
  ("faction_king_female_title_7", "Queen {s0}"),
  ("faction_king_female_title_8", "Queen {s0}"),
  ("faction_king_female_title_9", "{s0} Khan"),
  ("faction_king_female_title_10", "Queen {s0}"),
  ("faction_king_female_title_11", "Queen {s0}"),
  ("faction_king_female_title_12", "Sultan {s0}"),
  ("faction_king_female_title_13", "Queen {s0}"),
  ("faction_king_female_title_14", "Queen {s0}"),
## CC
  ...
  ("dplmc_reputation_unknown", "It's nothing known about {s46}."),
...
#======special item begin======
  ...
  ("upgrade_troop",   "upgrade {s12} to {s11} (costs {reg13} gold, remaining {reg12} )."),
  ("upgrade_item", "{reg10?{reg11?(upgrade {s11} {s10} ({reg12?{reg12} iron, {reg12} tools, :}{reg13} denars):{s11} {s10}}:None}"),
  ("upgrade_item_2", "{reg10?{reg11?({s11} => {s12}){s10} ({reg13?{reg13} iron, {reg13} tools, :}{reg14} denars):{s11} {s10}}:None}"),
  ("enter_blacksmith_relation","enter_blacksmith_relation"),
  ("enter_blacksmith_craftsman","enter_blacksmith_craftsman"),
  
  ("tavernkeeper_ask_npc_place_1", "I don't know where {s10} are"),
  ("tavernkeeper_ask_npc_place_2", "{s10} is in {s11}"),
  ("an_elixir", "elixir"),
   ...
   ("deposit", "In {s3} {reg2} thaler is collecting interest."),
...
("key_no15", "Call Horse"),
("key_no16", "use special_ability"),
("key_no17", "toggle horse charging"),
("key_no18", "use special_ability_2"),
("key_no19", "use powpower_strike"),
...
##PBOD
  ...
  ("start_phase_2", "You hear about Europe, a land torn between rival kingdoms battling each other for supremacy,\
 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about Europe and its kingdoms, you..."),
  ("start_phase_3", "You hear about Europe, a land torn between rival kingdoms battling each other for supremacy,\
 a haven for knights and mercenaries,  cutthroats and adventurers, all willing to risk their lives in pursuit of fortune, power, or glory...\
 In this land which holds great dangers and even greater opportunities, you believe you may leave your past behind and start a new life.\
 You feel that finally, you hold the key of your destiny in your hands, free to choose as you will,\
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about Europe and its kingdoms, you..."),
  ...
  ("lair_name_1", "farm"),
  ("lair_name_2", "nomad_tent"),
  ("lair_name_3", "graveyard"),
  ("lair_name_4", "gobin_slum"),
  ("lair_name_5", "imp_cache"),
  ("lair_name_6", "rogue_hideout"),
  ("lair_name_7", "longhouse"),
  ("lair_name_8", "dwarf_cottage"),
  ("lair_name_9", "elf_homestead"),
  ("lair_name_10", "monastery"),
  ("lair_name_11", "magic_guild"),
  ("lair_name_12", "keep"),
  ("lair_name_13", "cathedral"),
  ("lair_name_14", "demon_gate"),
  ("lair_name_15", "clan_halls"),
  ("lair_name_16", "vampire_estate"),
  ("lair_name_17", "ogre_fort"),
  ("lair_name_18", "wolf_pen"),
  ("lair_name_19", "labyrinth"),
  ("lair_name_20", "tomb_of_curses"),
  ("lair_name_21", "treant_alcove"),
  ("lair_name_22", "knights_chapter"),
  ("lair_name_23", "vampire_palace"),
  ("lair_name_24", "cloud_temple"),
  ("lair_name_25", "dragon_altar"),
  ("lair_name_26", "undead_magic_guild"),
  ("lair_name_27", "troll_cave"),
  ("lair_name_28", "altar_of_light"),
  ("lair_name_29", "temple_of_the_fallen"),
  ("lair_name_30", "forlorn_cathedral"),
  ("lair_name_31", "alchemist_lab"),
    
  ("faction_title_male_1_0", "Lord {s0}"),
  ("faction_title_male_1_1", "Baron {s0}"),
  ("faction_title_male_1_2", "Viscount {s0}"),
  ("faction_title_male_1_3", "Earl {s0}"),
  ("faction_title_male_1_4", "Marquess {s0}"),
  ("faction_title_male_1_5", "Duke {s0}"),
  ("faction_title_male_1_6", "Grand Duke {s0}"),
  
  ("faction_title_female_1_0", "Lord {s0}"),
  ("faction_title_female_1_1", "Baron {s0}"),
  ("faction_title_female_1_2", "Viscount {s0}"),
  ("faction_title_female_1_3", "Earl {s0}"),
  ("faction_title_female_1_4", "Marquess {s0}"),
  ("faction_title_female_1_5", "Duke {s0}"),
  ("faction_title_female_1_6", "Grand Duke {s0}"),
  ...
  ("town_24_intro", "2"),
  ("town_25_intro", "2"),
  ("center_intro_end", "end"),

## CC
  ("battlefield_small", "a small battlefield"),
  ("battlefield_normal", "an normal battlefield"),
  ...
  ("hint_19", "You can leave any location instantly by pressing the tab key."),
  ("hint_20", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_21", "You can leave any location instantly by pressing the tab key."),
  ("hint_22", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_23", "You can leave any location instantly by pressing the tab key."),
  ("hint_24", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_25", "You can leave any location instantly by pressing the tab key."),
  ("hint_26", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_27", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_28", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_29", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_30", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
  ("hint_31", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
...
## CC
   ...
   ("female_name_98", "name"),	
   ("female_name_99", "name"),	
   ("female_name_100", "name"),	
   ("female_name_101", "name"),	
   ("female_name_102", "name"),	
   ("female_name_103", "name"),	
   ("female_name_104", "name"),	
   ("female_name_105", "name"),	
   ("female_name_106", "name"),	
   ("female_name_107", "name"),	
   ("female_name_108", "name"),	
   ("female_name_109", "name"),	
   ("female_name_110", "name"),	
   ("female_name_111", "name"),	
   ("female_name_112", "name"),	
   ("female_name_113", "name"),	
   ("female_name_114", "name"),	
   ("female_name_115", "name"),	
   ("female_name_116", "name"),	
   ("female_name_117", "name"),	
   ("female_name_118", "name"),	
   ("female_name_119", "name"),	
   ("female_name_120", "name"),	
   ("female_name_121", "name"),	
   ("female_name_122", "name"),	
   ("female_name_123", "name"),	
   ("female_name_124", "name"),	
   ("female_name_125", "name"),	
   ("female_name_126", "name"),	
   ("female_name_127", "name"),	
   ("female_name_128", "name"),	
   ("female_name_129", "name"),	
   ("female_name_130", "name"),	
   ("female_name_131", "name"),	
   ("female_name_132", "name"),	
   ("female_name_133", "name"),	
   ("female_name_134", "name"),	
   ("female_name_135", "name"),	
   ("female_name_136", "name"),	
   ("female_name_137", "name"),	
   ("female_name_138", "name"),	
   ("female_name_139", "name"),	
   ("female_name_140", "name"),	
   ("female_name_141", "name"),	
   ("female_name_142", "name"),	
   ("female_name_143", "name"),	
   ("female_name_144", "name"),	
   ("female_name_145", "name"),	
   ("female_name_146", "name"),	
   ("female_name_147", "name"),	
   ("female_name_148", "name"),	
   ("female_name_149", "name"),	
   ("female_name_150", "name"),	
   ("female_name_151", "name"),	
   ("female_name_152", "name"),	
   ("female_name_153", "name"),	
   ("female_name_154", "name"),	
   ("female_name_155", "name"),	
   ("female_name_156", "name"),	
   ("female_name_157", "name"),	
   ("female_name_158", "name"),	
   ("female_name_159", "name"),	
   ("female_name_160", "name"),	
   ("female_name_161", "name"),	
   ("female_name_162", "name"),	
   ("female_name_163", "name"),	
   ("female_name_164", "name"),	
   ("female_name_165", "name"),	
   ("female_name_166", "name"),	
   ("female_name_167", "name"),	
   ("female_name_168", "name"),	
   ("female_name_169", "name"),	
   ("female_name_170", "name"),	
   ("female_name_171", "name"),	
   ("female_name_172", "name"),	
   ("female_name_173", "name"),	
   ("female_name_174", "name"),	
   ("female_name_175", "name"),	
   ("female_name_176", "name"),	
   ("female_name_177", "name"),	
   ("female_name_178", "name"),	
   ("female_name_179", "name"),	
   ("female_name_180", "name"),	
   ("female_name_181", "name"),	
   ("female_name_182", "name"),	
   ("female_name_183", "name"),	
   ("female_name_184", "name"),	
   ("female_name_185", "name"),	
   ("female_name_186", "name"),	
   ("female_name_187", "name"),	
   ("female_name_188", "name"),	
   ("female_name_189", "name"),	
   ("female_name_190", "name"),	
   ("female_name_191", "name"),	
   ("female_name_192", "name"),	
   ("female_name_193", "name"),	
   ("female_name_194", "name"),	
   ("female_name_195", "name"),	
   ("female_name_196", "name"),	
   ("female_name_197", "name"),	
   ("female_name_198", "name"),	
   ("female_name_199", "name"),	
   ("female_name_200", "name"),	
   ("female_name_201", "name"),	
   ("female_name_202", "name"),	
   ("female_name_203", "name"),	
   ("female_name_204", "name"),	
   ("female_name_205", "name"),	
   ("female_name_206", "name"),	
   ("female_name_207", "name"),	
   ("female_name_208", "name"),	
   ("female_name_209", "name"),	
   ("female_name_210", "name"),	
   ("female_name_211", "name"),	
   ("female_name_212", "name"),	
   ("female_name_213", "name"),	
   ("female_name_214", "name"),	
   ("female_name_215", "name"),	
   ("female_name_216", "name"),	
   ("female_name_217", "name"),	
   ("female_name_218", "name"),	
   ("female_name_219", "name"),	
   ("female_name_220", "name"),	
   ("female_name_221", "name"),	
   ("female_name_222", "name"),	
   ("female_name_223", "name"),	
   ("female_name_224", "name"),	
   ("female_name_225", "name"),	
   ("female_name_226", "name"),	
   ("female_name_227", "name"),	
   ("female_name_228", "name"),	
   ("female_name_229", "name"),	
   ("female_name_230", "name"),	
   ("female_name_231", "name"),	
   ("female_name_232", "name"),	
   ("female_name_233", "name"),	
   ("female_name_234", "name"),	
   ("female_name_235", "name"),	
   ("female_name_236", "name"),	
   ("female_name_237", "name"),	
   ("female_name_238", "name"),	
   ("female_name_239", "name"),	
   ("female_name_240", "name"),	
   ("female_name_241", "name"),	
   ("female_name_242", "name"),	
   ("female_name_243", "name"),	
   ("female_name_244", "name"),	
   ("female_name_245", "name"),	
   ("female_name_246", "name"),	
   ("female_name_247", "name"),	
   ("female_name_248", "name"),	
   ("female_name_249", "name"),	
   ("female_name_250", "name"),	
   ("female_name_251", "name"),	
   ("female_name_252", "name"),	
   ("female_name_253", "name"),	
   ("female_name_254", "name"),	
   ("female_name_255", "name"),	
   ("female_name_256", "name"),	
   ("female_name_257", "name"),	
   ("female_name_258", "name"),	
   ("female_name_259", "name"),	
   ("female_name_260", "name"),	
   ("female_name_261", "name"),	
   ("female_name_262", "name"),	
   ("female_name_263", "name"),	
   ("female_name_264", "name"),	
   ("female_name_265", "name"),	
   ("female_name_266", "name"),	
   ("female_name_267", "name"),	
   ("female_name_268", "name"),	
   ("female_name_269", "name"),	
   ("female_name_270", "name"),	
   ("female_name_271", "name"),	
   ("female_name_272", "name"),	
   ("female_name_273", "name"),	
   ("female_name_274", "name"),	
   ("female_name_275", "name"),	
   ("female_name_276", "name"),	
   ("female_name_277", "name"),	
   ("female_name_278", "name"),	
   ("female_name_279", "name"),	
   ("female_name_280", "name"),	
   ("female_name_281", "name"),	
   ("female_name_282", "name"),	
   ("female_name_283", "name"),	
   ("female_name_284", "name"),	
   ("female_name_285", "name"),	
   ("female_name_286", "name"),	
   ("female_name_287", "name"),	
   ("female_name_288", "name"),	
   ("female_name_289", "name"),	
   ("female_name_290", "name"),	
   ("female_name_291", "name"),	
   ("female_name_292", "name"),	
   ("female_name_293", "name"),	
   ("female_name_294", "name"),	
   ("female_name_295", "name"),	
   ("female_name_296", "name"),	
   ("female_name_297", "name"),	
   ("female_name_298", "name"),	
   ("female_name_299", "name"),	
   ("female_name_300", "name"),	
   ("female_name_301", "name"),	
   ("female_name_302", "name"),	
   ("female_name_303", "name"),	
   ("female_name_304", "name"),	
   ("female_name_305", "name"),	
   ("female_name_306", "name"),	
   ("female_name_307", "name"),	
   ("female_name_308", "name"),	
   ("female_name_309", "name"),	
   ("female_name_310", "name"),	
   ("female_name_end", "End"),
