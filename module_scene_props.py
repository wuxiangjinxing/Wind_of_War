...
head_dynamic_trigger = (ti_on_init_scene_prop,
     [
...
#  ("Baggage",sokf_place_at_origin|sokf_entity_body,"package","bobaggage"),
  ...
  ("banner_kingdom_13", 0, "banner_kingdom_14", "0", []),
...
("oil_press_interior",0,"oil_press_interior","bo_oil_press_interior", []),
  ...
  ("yellow_fall_leafs_a",0,"0","0",
   ...
   ("head_dynamic_male",sokf_moveable|sokf_dynamic_physics,"cut_off_head_male_dynamic","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_female",sokf_moveable|sokf_dynamic_physics,"cut_off_head_female_dynamic","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_skull",sokf_moveable|sokf_dynamic_physics,"barf_skull","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   
   ("head_dynamic_beastman",sokf_moveable|sokf_dynamic_physics,"beastman","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_mummy",sokf_moveable|sokf_dynamic_physics,"mummyhead","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_wolf",sokf_moveable|sokf_dynamic_physics,"WerewolfHead","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_orc",sokf_moveable|sokf_dynamic_physics,"orchead_test","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_ogre",sokf_moveable|sokf_dynamic_physics,"ogre_head2","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_goblin",sokf_moveable|sokf_dynamic_physics,"head_dynamic_goblin","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   
   ("head_dynamic_ent_green",sokf_moveable|sokf_dynamic_physics,"green_ent_head","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_ent_gold",sokf_moveable|sokf_dynamic_physics,"ent_head1","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_troll",sokf_moveable|sokf_dynamic_physics,"troll_head","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_olog",sokf_moveable|sokf_dynamic_physics,"olog_head","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   
   ("head_dynamic_demon_1",sokf_moveable|sokf_dynamic_physics,"demon_head_01","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_rat",sokf_moveable|sokf_dynamic_physics,"SkavenHead","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_zombie_1",sokf_moveable|sokf_dynamic_physics,"undeadface_f","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_zombie_2",sokf_moveable|sokf_dynamic_physics,"undeadface_green","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
   ("head_dynamic_draugr",sokf_moveable|sokf_dynamic_physics,"draugr_head","bo_cut_off_head_dynamic", [head_dynamic_trigger,]),
  ...
  ("tent_yellow", 0, "tent_yellow", "bo_tent", []),
  ("tent_canvas", 0, "tent_canvas", "bo_tent", []),
  ("tent_green", 0, "tent_green", "bo_tent", []),
  ("tent_red", 0, "tent_red", "bo_tent", []),
  ("tent_interior", 0, "tent_interior", "bo_tent_interior", []),
  ("g_prision_wagon", 0, "prision_wagon", "bo_prision_wagon", []),
