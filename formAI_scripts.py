  ...
  ("field_tactics", [
	...
	(try_for_range, ":ai_team", 0, 4),
		...
		(try_begin),
			...
			(this_or_next|eq, ":ai_faction", fac_swiss),	#deserters have military training
			(this_or_next|eq, ":ai_faction", fac_scotland),	#deserters have military training
			(this_or_next|eq, ":ai_faction", fac_hospitalier_knights),	#deserters have military training
    ...
    [
      ...
      (try_begin),
        ...
        (else_try),
          ...
          (party_slot_eq, "p_main_party", slot_party_agent_never_running_away, 0),#chenwz
