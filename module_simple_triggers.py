        ...
        (try_begin),
          ...
          (else_try),
            ...
            (try_begin),	  
              ...
              (else_try),
                (eq, ":random_no", 3),
                (assign, ":bandit_troop", "trp_skeleton"),
              (else_try),
                (eq, ":random_no", 4),
   ...
   [
    ...
    (try_for_parties, ":party_no"),
      ...
      (neq, ":party_no", "p_main_party"),
       (try_begin),
         (eq, 1, 0),
         (party_slot_eq, ":party_no", slot_party_type, spt_adventurer_party),
         (party_get_position, pos51, ":party_no"),
         (position_get_x, ":x_party", pos51),
         (position_get_y, ":y_party", pos51),
         (this_or_next|gt, ":x_party", 230),
         (this_or_next|lt, ":x_party", -230),
         (this_or_next|gt, ":y_party",280),
         (lt, ":y_party", -280),

         (assign, ":nearest_town", -1),
         (assign, ":lowest_distance", 999999),
         (try_for_range, ":town", towns_begin, towns_end),
           (party_slot_eq, ":town", slot_party_type, spt_town),
           (store_distance_to_party_from_party, ":dis", ":party_no", ":town"),
           (le, ":dis", ":lowest_distance"),
           (assign, ":lowest_distance", ":dis"),
           (assign, ":nearest_town", ":town"),
         (try_end),
         (gt, ":nearest_town", -1),

         (party_relocate_near_party, ":party_no", ":nearest_town", 1), 
       (try_end),
    ...
    (call_script,"script_change_player_effect", 0),
        ...
        #  (try_end),
        #  (eq, ":pass", 1),
        #  (party_get_free_companions_capacity,":pass","p_main_party"),
        #  (ge, ":pass", 1),
        ...
        #  (neg|troop_slot_ge, ":troop_no", slot_troop_prisoner_of_party, 0),
        #  (neg|main_party_has_troop, ":troop_no"),
        #  (call_script, "script_recruit_troop_as_companion", ":troop_no", 0),
        #(try_end),
   ...
   (24,
    [
     (try_for_range, ":adventurer", active_npcs_begin, active_npcs_end),
       ...
       #(troop_slot_eq, ":adventurer", slot_troop_spawned_before, 1), #HeartFly
       (try_begin),
         (troop_slot_eq, ":adventurer", slot_troop_occupation, slto_inactive),
     ...
     (try_end),
      ...
      (try_for_range, ":troop_no", adventurer_troops_begin, adventurer_troops_end),
        (neg|main_party_has_troop, ":troop_no"),
         ...
         (neg|troop_slot_eq, ":troop_no", slot_troop_occupation, slto_kingdom_hero),
         (neg|troop_slot_eq, ":troop_no", slot_troop_occupation, slto_player_companion),
         (neg|troop_slot_eq, ":troop_no", slot_troop_current_mission, npc_mission_gather_intel),
         (neg|troop_slot_eq, ":troop_no", slot_troop_current_mission, npc_mission_kingsupport),
         (troop_slot_eq, ":troop_no", slot_troop_days_on_mission, 0),
         (neg|troop_slot_ge, ":troop_no", slot_troop_prisoner_of_party, 0),
         (neg|troop_slot_ge, ":troop_no", slot_troop_leaded_party, 1),
