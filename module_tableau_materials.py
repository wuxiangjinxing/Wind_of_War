...
tableaus = [
  ...
  ("shield_otto1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_otto_2", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
       
  ("shield_otto2", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_otto_3", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
       
  ("shield_otto3", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
  ...
  ("custom_banner_square2", 0, "missiles", 256, 256, 0, 0, 0, 0,
   [
     (store_script_param, ":banner_mesh", 1),
     (set_fixed_point_multiplier, 100),
  ...
  #("early_transitional_heraldic", 0, "sample_early_transitional_heraldic_banner", 1024, 1024, 0, 0, 0, 0,
   #[
       ...
       #(try_begin),
         ...
         #(init_position, pos1),
         #(call_script, "script_draw_banner_to_region", ":troop_no", 60, -57, 10000, 10000, 2000, 2000, 4000, 10000, 1),
       #(else_try),
         #(store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         #(troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         #(cur_tableau_set_background_color, ":background_color"),
       ...
       #(try_begin),
         #(lt, ":troop_no", 0),
         #(cur_tableau_add_mesh, "mesh_tableau_mesh_early_transitional_heraldic", pos1, 0, 0),
       #(else_try),
         #(eq, ":troop_no", 0),
...
##     ]),
 ...
 ("rank_troop", 0, "troop_portrait", 1024, 1024, 0, 0, 600, 600,
  [
    ...
    (else_try),
      (eq, ":class", 1),
      (cur_tableau_add_override_item, "itm_straw_hat"),
      (cur_tableau_add_override_item, "itm_coarse_tunic"),
    ...
    (else_try),
      (eq, ":class", 3),
      (cur_tableau_add_override_item, "itm_rich_outfit"),
      (cur_tableau_add_override_item, "itm_leather_boots"),
    ...
    (else_try),
      (eq, ":class", 4),
      (cur_tableau_add_override_item, "itm_haubergeon"),
      (cur_tableau_add_override_item, "itm_splinted_leather_greaves"),
      (cur_tableau_add_override_item, "itm_leather_gloves"),
      (cur_tableau_add_override_item, "itm_tab_shield_heater_cav_a"),
      (cur_tableau_add_override_item, "itm_sword_medieval_a"),
      (assign, ":animation", "anim_pose_3"),
    (else_try),
      (eq, ":class", 5),
      (cur_tableau_add_override_item, "itm_tab_shield_heater_cav_a"),
      (cur_tableau_add_override_item, "itm_wisby_gauntlets_black"),
      (cur_tableau_add_override_item, "itm_iron_greaves2"),
      (cur_tableau_add_override_item, "itm_early_transitional_heraldic"),
      (cur_tableau_add_override_item, "itm_sword_medieval_a"),
      (assign, ":animation", "anim_pose_3"),
    (else_try),
      (eq, ":class", 6),
      (cur_tableau_add_override_item, "itm_hounskull"),
      (cur_tableau_add_override_item, "itm_half_plates"),
      (cur_tableau_add_override_item, "itm_iron_greaves2"),
      (cur_tableau_add_override_item, "itm_hourglass_gauntlets"),
      (cur_tableau_add_override_item, "itm_tab_shield_heater_cav_a"),
    ...
    (else_try),
      (eq, ":class", 7),
      (cur_tableau_add_override_item, "itm_heraldic_plate"),
      (cur_tableau_add_override_item, "itm_iron_greaves"),
      (cur_tableau_add_override_item, "itm_hourglass_gauntlets_ornate"),
      (cur_tableau_add_override_item, "itm_bastard_sword_e"),
      (assign, ":animation", "anim_pose_4"),
    ...
    (else_try),
      ...
      (cur_tableau_add_override_item, "itm_iron_greaves2"),
      (cur_tableau_add_override_item, "itm_hourglass_gauntlets_ornate"),
      (cur_tableau_add_override_item, "itm_bastard_sword_f"),
      (assign, ":animation", "anim_pose_4"),
    (else_try),
      (eq, ":class", 9),
      (cur_tableau_add_override_item, "itm_new_sallet"),
      (cur_tableau_add_override_item, "itm_gothic_plate"),
      (cur_tableau_add_override_item, "itm_steel_greaves"),
    ...
    (else_try),
      (eq, ":class", 14),
      (cur_tableau_add_override_item, "itm_crown"),
      (cur_tableau_add_override_item, "itm_courtly_outfit"),
      (cur_tableau_add_override_item, "itm_leather_boots"),
      (cur_tableau_add_override_item, "itm_sword_medieval_c"),
      (assign, ":animation", "anim_pose_5"),
