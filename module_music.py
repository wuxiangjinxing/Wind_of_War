...
## CC
  ...
  ("c1", "Echo_in_Eternity.mp3",   mtf_module_track|mtf_start_immediately, 0),
  ("c2", "minstrelosity.mp3", mtf_module_track|mtf_start_immediately, 0),
  ("c3", "Bard's_Tale.mp3",   mtf_module_track|mtf_start_immediately, 0),
  ("c4", "Braveheart.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c5", "New_Begining.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c6", "Where_my_Heart_is.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c7", "March_of_Honor.mp3", mtf_module_track|mtf_start_immediately, 0),
  ("c8", "Castle_Dance.mp3",   mtf_module_track|mtf_start_immediately, 0),
  ("c9", "life.mp3", mtf_module_track|mtf_start_immediately, 0),
  ("c10",  "The_Die_is_Cast.mp3", mtf_module_track|mtf_start_immediately, 0),
  ("c11", "Dove_in_the_Sky.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c12", "Handful_of_Sorrow.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c13", "minstrelosity.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c14", "credits.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c15", "reluctanthero.mp3",  mtf_module_track|mtf_start_immediately, 0),
  ("c16", "Pride_or_Pain.mp3", mtf_module_track|mtf_start_immediately, 0),
