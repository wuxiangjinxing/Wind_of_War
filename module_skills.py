...
skills = [
  ...
  ("magic_defence","Magic_Defense",sf_base_att_cha,15,"This_skill_represents_your_resistance_to_magical_attacks."), 
  ("paragon_knight","paragon_knight",sf_base_att_cha,15,"This is a reserved skill."), 
  ("persuasion","Persuasion", sf_base_att_cha,15, "This skill helps you make other people accept your point of view. (Personal skill)  Max level: 10"),
  ("engineer","Engineer",sf_base_att_int|sf_effects_party,15,"This skill allows you to construct siege equipment and fief improvements more efficiently. (Party skill)  Max level: 10"),
  ("undead_master","undead_master",sf_base_att_int,15,"This is a reserved skill."), 
  ("surgery","Surgery",sf_base_att_int|sf_effects_party|sf_inactive,15,"Each point to this skill gives a 5.5%% chance that a mortally struck party member will be wounded rather than killed. (Party skill)  Max level: 10"), 
  ("first_aid", "First Aid",sf_base_att_int|sf_effects_party,15,"Heroes regain 5%% per skill level of hit-points lost during mission. (Party skill)  Max level: 10"), 
  ("wound_treatment","Wound Treatment",sf_base_att_int|sf_effects_party,15,"Party healing speed is increased by 20%% per level of this skill. (Party skill)  Max level: 10"), 
  ("inventory_management","Inventory Management",sf_base_att_int,15,"Increases inventory capacity by +6 per skill level. (Leader skill)  Max level: 10"), 
  ...
  ("trainer","Trainer",sf_base_att_int,15,"Every day, each hero with this skill adds some experience to every other member of the party whose level is lower than his/hers. Experience gained goes as: {0,4,10,16,23,30,38,46,55,65,80}. (Personal skill)  Max level: 10"),
  ("necromancy","Necromancy",sf_base_att_int,15,"each skill can Improve Summon creatures Control time 1 min. After the battle, skill can Collecting souls of the dead, it Can be used to create undead, summon demons, or create medals"),   
  ...
  ("archer_comman","archer_comman",sf_base_att_int,15,"This is a reserved skill."), 
  ...
  ("horse_archery","Horse Archery",sf_base_att_agi,15,"Reduces damage and accuracy penalties for archery and throwing from horseback. (Personal skill)  Max level: 10"),
  ("riding","Riding",sf_base_att_agi,15,"Enables you to ride horses of higher difficulty levels and increases your riding speed and manuever. (Personal skill)  Max level: 10"),
  ("athletics","Athletics",sf_base_att_agi|sf_inactive,15,"Improves your running speed. (Personal skill)  Max level: 10"),
  ("shield","Shield",sf_base_att_str,15,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)  Max level: 10"),
  ("weapon_master","Weapon Master",sf_base_att_agi,15,"Makes it easier to learn weapon proficiencies and increases the proficiency limits. Limits go as: 60, 100, 140, 180, 220, 260, 300, 340, 380, 420. (Personal skill)  Max level: 10"),
  ...
  ("reserved_11","Reserved Skill 11",sf_base_att_agi|sf_inactive,15,"This is a reserved skill."), 
  ("reserved_12","Reserved Skill 12",sf_base_att_agi|sf_inactive,15,"This is a reserved skill."), 
  ("reserved_13","Reserved Skill 13",sf_base_att_agi|sf_inactive,15,"This is a reserved skill."), 
  ...
  #("reserved_15","Reserved Skill 15",sf_base_att_str|sf_inactive,15,"This is a reserved skill."), 
  ("reserved_16","Reserved Skill 16",sf_base_att_str|sf_inactive,15,"This is a reserved skill."), 
  ("reserved_17","Reserved Skill 17",sf_base_att_str|sf_inactive,15,"This is a reserved skill."), 
  ("reserved_18","Reserved Skill 18",sf_base_att_str|sf_inactive,15,"This is a reserved skill."), 
]
