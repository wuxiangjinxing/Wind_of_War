...
def wp_one_handed(x):
  return (((bignum |(x*9/8)) & 0x3FF) << one_handed_bits)
def wp_two_handed(x):
  return (((bignum |(x*9/8)) & 0x3FF) << two_handed_bits)
def wp_polearm(x):
  return (((bignum |(x*9/8)) & 0x3FF) << polearm_bits)
def wp_archery(x):
  return (((bignum |(x*9/8)) & 0x3FF) << archery_bits)
def wp_crossbow(x):
  return (((bignum |(x*9/8)) & 0x3FF) << crossbow_bits)
def wp_throwing(x):
  return (((bignum |(x*9/8)) & 0x3FF) << throwing_bits)
def wp_firearm(x):
  return (((bignum |(x*9/8)) & 0x3FF) << firearm_bits)
## CC
