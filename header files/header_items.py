...
itp_is_glaive                = 0x0001000000000000
itp_is_magic_staff           = 0x0000200000000000
itp_is_bomb                  = 0x0000800000000000
...
itc_gauntlet =   (itcf_thrust_onehanded|itcf_overswing_twohanded|itcf_slashright_onehanded|itcf_slashleft_onehanded) | itcf_horseback_slashright_onehanded | itcf_horseback_overswing_left_onehanded | itc_parry_onehanded
...
itc_bastardsword = itc_cut_two_handed |  itcf_thrust_twohanded | itc_parry_two_handed |itc_dagger | itcf_horseback_thrust_onehanded
...
itc_guisarme      = itc_cutting_spear | itc_cleaver

itc_glaive = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_slashright_twohanded|itcf_slashleft_twohanded|itcf_thrust_onehanded_lance|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm

itc_long_glaive   = itc_staff | itcf_horseback_slashright_onehanded | itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm

itc_guandao       = itc_poleaxe | itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm

itc_greatlance = itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback| itcf_thrust_polearm

itc_shortened_spear      = itc_parry_polearm| itcf_thrust_onehanded |itcf_horseback_thrust_onehanded | itcf_thrust_polearm | itcf_overswing_spear
