   ...
   ("cf_agent_voice_storm_call",
    [
     (store_script_param, ":agent_call_lightning",1),
         

    
     (agent_get_troop_id, ":troop_no", ":agent_call_lightning"),
     ...
     (try_for_agents,":agent"),
       ...
       (this_or_next|agent_is_ally,":agent_call_lightning"),
       (agent_is_ally,":agent"),
       (this_or_next|neg|agent_is_ally,":agent"),
       (neg|agent_is_ally,":agent_call_lightning"),
       
       (agent_get_slot, ":special", ":agent", slot_agent_special_ability_affect_type),
       (neg|eq,":special", stoneskin),
       (neg|eq,":special", holy_light),
       (neg|agent_slot_eq, ":agent", slot_agent_has_been_special_ability, call_lightning), 
       (store_random_in_range, ":randon", 0, 5),
       (eq,":randon",0),
     ...
     (agent_set_slot, ":victim", slot_agent_has_been_special_ability, call_lightning),
     ...
     (try_begin),
         ...
         (call_script, "script_get_special_ability_text_to_s2", call_lightning, 0),
         (display_message, "@you hit by thunder by {s1}.", 0xFF0000),
     (try_end),
     ...
     (store_skill_level, ":power", skl_magic_power, ":troop_no"),
        ...
        (store_random_in_range, ":randon_damage", 25, 51),
      ...
      (try_begin),
        (gt,":damage",0),
        (particle_system_burst, "psys_thunder", pos2, 1),
        (play_sound_at_position, "snd_thunder_hit", pos2),
      (try_end),
      ...
      #  (neg|agent_is_ally,":agent_call_lightning"),
        ...
        (call_script, "script_magic_deliver_damage_to_agent", ":agent_call_lightning", ":agent", ":max_damage", thunder, ":power", 15),
