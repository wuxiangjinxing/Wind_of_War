...
sounds = [
 ("click", sf_2d|sf_vol_10,["BUTTON.wav"]),
 ("tutorial_1", sf_2d|sf_vol_7,["tutorial_1.ogg"]),
 ("tutorial_2", sf_2d|sf_vol_7,["tutorial_2.ogg"]),
 ("gong", sf_2d|sf_priority_9|sf_vol_7, ["NWHEROLV.wav"]),
 ("quest_taken", sf_2d|sf_priority_9|sf_vol_5, ["QUEST.wav","MYSTERY.wav"]),
 ("quest_completed", sf_2d|sf_priority_9|sf_vol_8, ["quest_completed.ogg","GOODLUCK.wav"]),
 ...
 ("quest_failed", sf_2d|sf_priority_9|sf_vol_7, ["GRAVEYARD.wav","BADLUCK.wav","BADMRLE.wav"]),
 ...
 ("rain",sf_2d|sf_priority_10|sf_vol_9|sf_looping, ["rain_1.ogg"]),
...
# ("footstep_horse_1f",sf_priority_3|sf_vol_8, ["footstep_horse_5.ogg","footstep_horse_2.ogg","footstep_horse_3.ogg","footstep_horse_4.ogg"]),
 ...
 ("bullet_pass_by",sf_priority_7, ["swist_puli1.wav","swist_puli2.wav","swist_puli3.wav","swist_puli4.wav","swist_puli5.wav"]),
...
## ("shield_hit_cut",sf_priority_5, ["shield_hit_cut_3.ogg","shield_hit_cut_4.ogg","shield_hit_cut_5.ogg"]),
 ...
 ("battle",sf_vol_4, ["battle.ogg","LOOPSKEL.wav"]),
...
# ("crossbow_shoot",sf_priority_4, ["bow_shoot_2.ogg"]),
 ...
 ("skeleton_yell",sf_priority_3|sf_vol_7, ["skeleton_yell01.wav","skeleton_yell02.wav","skeleton_yell03.wav","skeleton_yell04.wav","skeleton_yell05.wav"]),
 ("skeleton_death",sf_priority_3|sf_vol_7, ["skeleton_death01.wav","skeleton_death02.wav","skeleton_death03.wav","skeleton_death04.wav"]),
 ("skeleton_hit",sf_priority_3|sf_vol_7, ["blunt_high_high_01.wav","blunt_high_high_04.wav","blunt_high_high-08.wav","blunt_high_high_012.wav","blunt_high_high_16.wav",]),
...
#TODONOW:
 ...
 ("distant_blacksmith", sf_2d|sf_priority_3|sf_vol_4, ["d_blacksmith2.ogg","LOOPFACT.wav","LOOPTITA.wav"]),
 ...
 ("release_musket",sf_vol_15|sf_priority_14, ["musket_fire_close_1.wav","musket_fire_close_2.wav","musket_fire_close_3.wav","musket_fire_close_5.wav","musket_fire_close_6.wav"]),
 ("release_musket_medium",sf_vol_15|sf_priority_13, ["musket_fire_medium_2.wav","musket_fire_medium_4.wav","musket_fire_medium_5.wav","musket_fire_medium_6.wav"]),
 ("release_musket_far",sf_vol_15|sf_priority_12, ["musket_fire_far_4.wav","musket_fire_far_4b.wav"]),
 ("cannon_shot",sf_priority_10|sf_vol_10, ["CannonShot2.wav"]),
 
 ("release_laser",sf_vol_7, ["blaster04_long.mp3","bigblaster19_DL44_DH17_short.mp3","bigblaster22_EE3_bowcaster_variant.mp3","bigblaster01.mp3","bigblaster15_E11_variant.mp3"]),
 ("reload_laser",sf_vol_3, ["blaster_reload_a.mp3","blaster_reload_b.mp3"]),
  
 ("troll_die",sf_priority_10,  ["troll_die_1.wav","troll_die_2.wav","troll_die_3.wav"]),
 ("troll_hit",sf_priority_7|sf_vol_10, ["troll_hit_1.wav","troll_hit_2.wav","troll_hit_3.wav"]), 
 ("troll_grunt",sf_priority_6|sf_vol_4, ["troll_hurt_1.wav","troll_hurt_2.wav","troll_hurt_3.wav"]),
 ("troll_yell",sf_priority_6|sf_vol_8, ["troll_warcry_1.wav","troll_warcry_2.wav","troll_warcry_3.wav"]), 
 ("troll_victory",sf_priority_5|sf_vol_10, ["troll_warcry_2.wav","troll_warcry_3.wav"]), 
 
 ("goblin_grunt",sf_priority_6|sf_vol_4, ["hbgoblin_grunt.wav"]),
 ("goblin_hit",sf_priority_7|sf_vol_7, ["hbgoblin_hit.wav"]),
 ("goblin_die",sf_priority_10|sf_vol_8,  ["hbgoblin_die.wav"]),
 ("goblin_warcry",sf_priority_6|sf_vol_4, ["hbgoblin_warcry.wav"]),
 
 ("trophy_get", sf_2d|sf_priority_9|sf_vol_6, ["TREASURE.wav"]),
 ("artifact_get",sf_2d|sf_priority_10|sf_vol_10, ["ULTIMATEARTIFACT.wav"]),
 ("battle_begin",sf_2d|sf_priority_6|sf_vol_4, ["BATTLE00.wav","BATTLE01.wav","BATTLE02.wav","BATTLE03.wav","BATTLE04.wav","BATTLE05.wav","BATTLE06.wav","BATTLE07.wav",]),
 ("thunder_hit",sf_priority_15|sf_vol_15, ["LIGHTBLT.wav"]),
 ("blood_lust",sf_priority_10|sf_vol_10, ["BLOODLUS.wav"]),
 
 ("weakness",sf_priority_10|sf_vol_10, ["WEAKNESS.wav"]),
 
 ("regeneration",sf_priority_10|sf_vol_10, ["RESURECT.wav"]),
 ("haste",sf_priority_10|sf_vol_10, ["TAILWIND.wav"]),
 ("slow",sf_priority_10|sf_vol_10, ["QUIKSAND.wav"]),
 ("bless",sf_priority_10|sf_vol_10, ["BLESS.wav","MIRTH.wav"]),
 ("curse",sf_priority_10|sf_vol_10, ["CURSE.wav","MANADRAI.wav"]),
 ("death_cld",sf_priority_10|sf_vol_10, ["DEATHCLD.wav"]),
 ("stoneskin",sf_priority_10|sf_vol_10, ["DRAINLIF.wav"]),
 ("spell_dispel",sf_priority_10|sf_vol_10, ["DISRUPTR.wav","SCUTBOAT.wav","MANADRAI.wav","ANTIMAGK.wav"]),


 ("forst_ring",sf_priority_10|sf_vol_10, ["FROSTING.wav"]),
 ("flame_burst",sf_priority_10|sf_vol_10, ["FIREBLST.wav","FIREWALL.wav"]),
 ("fear",sf_priority_10|sf_vol_10, ["FEAR.wav"]),


 ("spell_cast",sf_vol_10|sf_priority_10, ["AMAGSHOT.wav","BHDRSHOT.wav","ENCHSHOT.wav","ESULSHOT.wav","EVLISHOT.wav","LICHSHOT.wav","MAGESHOT.wav","MONKSHOT.wav","ZELTSHOT.wav"]),
 
 ("meteor_fall",sf_priority_15|sf_vol_15, ["METEOR.wav"]),
 ("slayer",sf_priority_15|sf_vol_15, ["SLAYER.wav","DEATHBLO.wav"]),
 
 ("new_day", sf_2d|sf_priority_9|sf_vol_6, ["NEWDAY.wav"]),
 ("new_month", sf_2d|sf_priority_9|sf_vol_6, ["NEWMONTH.wav"]),
 ("pay_day", sf_2d|sf_priority_9|sf_vol_6, ["NEWWEEK.wav"]),
 ("meet_ememy", sf_priority_9|sf_vol_6, ["ROGUE.wav","DANGER.wav","DRAGON.wav"]),

 ("encounter_ememy", sf_priority_9|sf_vol_6, ["ROGUE.wav"]),
 ("encounter_castle_outside", sf_priority_9|sf_vol_6, ["DRAGON.wav"]),
 ("win_battle",sf_2d|sf_priority_10|sf_vol_10, ["Win_Battle.mp3","Defend_Castle.mp3"]),
 ("loss_battle",sf_2d|sf_priority_10|sf_vol_5, ["LoseCombat.mp3","LoseCastle.mp3","Surrende_Battle.mp3"]),
 ("retreat",sf_2d|sf_priority_10|sf_vol_5, ["Retreat_Battle.mp3"]),
 
 ("end_day", sf_2d|sf_priority_9|sf_vol_5,["LOOPWOLF.wav"]),
 ("new_come",sf_priority_10|sf_vol_10, ["PLAYCOME.wav","combatstart.mp3"]),
 
 ("good_moral", sf_2d|sf_priority_9|sf_vol_6, ["NOMAD.wav","CLIMAX.wav","FAERIE.wav","GOODMRLE.wav","LOOPFLAG.wav","LUCK.wav","MORALE.wav","GOODLUCK.wav"]),
 
 ("gate", sf_2d|sf_priority_9|sf_vol_5,["LOOPGATE.wav","TELPTOUT.wav","TELPTIN.wav","HYPNOTIZ.wav"]),

 ("camp", sf_2d|sf_priority_9|sf_vol_5,["LOOPMARK.wav","LOOPCAMP.wav","LOOPMERC.wav","LOOPFIRE.wav","LOOPSKEL.wav"]),
 ("market", sf_2d|sf_priority_9|sf_vol_5,["LOOPMARK.wav","h4Marketplace.mp3","town_loop_3.ogg"]),
 
 ("chest", sf_2d|sf_priority_9|sf_vol_5,["CHEST.wav","TREASURE.wav","h4Treasure_Chest.mp3"]),
  
 ("add_exp", sf_2d|sf_priority_9|sf_vol_5,["EXPERNCE.wav","CHEST.wav"]),
 
 ("artifact", sf_2d|sf_priority_9|sf_vol_6, ["h4Artifact.mp3"]),
 ("creature_bank", sf_2d|sf_priority_9|sf_vol_6, ["h4Creature_Bank.mp3"]),
 ("marketplace", sf_2d|sf_priority_9|sf_vol_6, ["h4Marketplace.mp3"]),
 ("portal", sf_2d|sf_priority_9|sf_vol_6, ["h4Portal.mp3"]),
 ("stables", sf_2d|sf_priority_9|sf_vol_6, ["h4Stables.mp3"]),
 ("tavern", sf_2d|sf_priority_9|sf_vol_6, ["h4Tavern.mp3"]),
 ("thieves_guild", sf_2d|sf_priority_9|sf_vol_6, ["h4Thieves_Guild.mp3"]),
 ("watch_tower", sf_2d|sf_priority_9|sf_vol_6, ["h4Tower.mp3"]),
 ("treasure", sf_2d|sf_priority_9|sf_vol_6, ["h4Treasure.mp3"]),
 ("university", sf_2d|sf_priority_9|sf_vol_6, ["h4University.mp3"]),
 
 ("lair", sf_2d|sf_priority_9|sf_vol_5,["LOOPDEN.wav","LOOPDWAR.wav","LOOPELF.wav","LOOPDWAR.wav","LOOPDWAR.wav","DRAGON.wav"]),
 ("blacksmith", sf_2d|sf_priority_9|sf_vol_5,["LOOPFACT.wav","LOOPFIRE.wav","LOOPELF.wav","LOOPTITA.wav"]),
 
 ("lair_keep", sf_2d|sf_priority_9|sf_vol_5,["LOOPARCH.wav","LOOPAREN.wav","LOOPHORS.wav","LOOPORC.wav","LOOPPIKE.wav","LOOPSKEL.wav"]),
 ("lair_elf", sf_2d|sf_priority_9|sf_vol_5,["LOOPARCH.wav","LOOPELF.wav","LOOPFAER.wav","LOOPGARD.wav"]),
 
 ("lair_dwarf", sf_2d|sf_priority_9|sf_vol_5,["LOOPCRYS.wav","LOOPFACT.wav","LOOPDWAR.wav","LOOPMINE.wav","LOOPTITA.wav"]),
 ("lair_monastery", sf_2d|sf_priority_9|sf_vol_5,["LOOPMONK.wav","LOOPSANC.wav","LOOPSHRIN.wav","TEMPLE.wav","LOOPSANC.wav"]),
 ("lair_magic", sf_2d|sf_priority_9|sf_vol_5,["LOOPLEAR.wav","LOOPMAGI.wav","LOOPSHRIN.wav","GETPROTECTION.wav","LOOPMAGI.wav"]),

 ("lair_undead", sf_2d|sf_priority_9|sf_vol_5,["GRAVEYARD.wav","LOOPCURS.wav","LOOPDEAD.wav"]),
 ("lair_demon", sf_2d|sf_priority_9|sf_vol_5,["LOOPDEVL.wav","LOOPDOG.wav"]),
 ("lair_orc", sf_2d|sf_priority_9|sf_vol_5,["LOOPGOBL.wav","LOOPCAMP.wav","LOOPOGRE.wav","LOOPORC.wav","LOOPCAMP.wav"]),
 ("lair_nomad", sf_2d|sf_priority_9|sf_vol_5,["NOMAD.wav","LOOPCAMP.wav","LOOPHORS.wav","LOOPUNIC.wav"]),

 ("lair_cave", sf_2d|sf_priority_9|sf_vol_5,["LOOPCAVE.wav","LOOPDRAG.wav","CAVEHEAD.wav","DRAGON.wav"]),
...
("holy_call",sf_priority_15|sf_vol_15, ["holy_grenade.ogg"]),
...
("cast_summon_neutral",sf_priority_10|sf_vol_10, ["Animal_Allegiance.mp3"]),
("cast_stoneskin",sf_priority_10|sf_vol_10, ["Become_Ethereal.mp3"]),

("cast_summon_hallow",sf_priority_10|sf_vol_10, ["Call_of_Valor.mp3"]),
("cast_warcry",sf_priority_10|sf_vol_10, ["Dismaying_Shout.mp3"]),
("cast_battlecry",sf_priority_10|sf_vol_10, ["Elemental_Fury.mp3"]),
("cast_flame_burst",sf_priority_10|sf_vol_10, ["Fire_Breath.mp3"]),
("cast_forst_ring",sf_priority_10|sf_vol_10, ["Frost_Breath.mp3"]),
("cast_forst_ring_2",sf_priority_10|sf_vol_10, ["Ice_Form.mp3"]),
("cast_earth_shock",sf_priority_10|sf_vol_10, ["Unrelenting_Force.mp3"]),

("cast_mummy_curse",sf_priority_10|sf_vol_10, ["Marked_for_Death.mp3"]),
("cast_call_lightning",sf_priority_10|sf_vol_10, ["Storm_Call.mp3"]),
("cast_taunt",sf_priority_10|sf_vol_10, ["Throw_Voice.mp3"]),
("cast_force_jump",sf_priority_10|sf_vol_10, ["Whirlwind_Sprint.mp3"]),
 
 ("dice_roll",sf_priority_10|sf_vol_10, ["dice_roll.wav"]),
 
("dragon_blade_Slash",sf_priority_15|sf_vol_15, ["dragon_blade_Slash.mp3"]),
 

("voice_clear_skies",sf_priority_10|sf_vol_10, ["Clear_Skies.mp3"]),
("voice_cyclone",sf_priority_10|sf_vol_10, ["voice_Cyclone.mp3"]),
("voice_unrelenting_force",sf_priority_10|sf_vol_10, ["Unrelenting_Force.mp3"]),
("voice_become_ethereal",sf_priority_10|sf_vol_10, ["Become_Ethereal.mp3"]),
("voice_slow_time",sf_priority_10|sf_vol_10, ["Slow_Time.mp3"]),
("voice_animal_allegiance",sf_priority_10|sf_vol_10, ["Animal_Allegiance.mp3"]),
("voice_storm_call",sf_priority_10|sf_vol_10, ["Storm_Call.mp3"]),
("voice_call_dragon",sf_priority_10|sf_vol_10, ["Call_Dragon.mp3"]),
("voice_call_of_valor",sf_priority_10|sf_vol_10, ["Call_of_Valor.mp3"]),
("voice_disarm",sf_priority_10|sf_vol_10, ["Disarm.mp3"]),
("voice_dismaying_shout",sf_priority_10|sf_vol_10, ["Dismaying_Shout.mp3"]),
("voice_bend_will",sf_priority_10|sf_vol_10, ["Bend_Will.mp3"]),
("voice_fire_breath",sf_priority_10|sf_vol_10, ["Fire_Breath.mp3"]),
("voice_whirlwind_sprint",sf_priority_10|sf_vol_10, ["Whirlwind_Sprint.mp3"]),
("voice_frost_breath",sf_priority_10|sf_vol_10, ["Frost_Breath.mp3"]),
("voice_ice_form",sf_priority_10|sf_vol_10, ["Ice_Form.mp3"]),
("voice_marked_for_death",sf_priority_10|sf_vol_10, ["Marked_for_Death.mp3"]),
