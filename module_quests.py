...
# Note : This is defined as the first mayor quest in module_constants.py: 
 ...
 ("deliver_goods", "Deliver {reg5} Units of {s6} to {s4}", qf_random_quest,
  "{!}{s9} of {s3} asked you to deliver {reg5} units of {s6} to the goods_merchant in {s4} in 7 days."
  ),
############
...
#Courtship quests
 ...
 ("hunted_down_bandits", "Hunt Down_bandits_band", qf_random_quest,
  "{!}{s9} of {s4} asked you to hunt down the {s10} in the vicinity of the town."
  ),
    
 ("deliver_food", "Bring {reg5} Units of {s6} to {s3}", qf_random_quest,
  "{!}{s9} of {s3} asked you to bring them {reg5} packs of {s6} in 7 days..."
  ), 

 #("hunted_robber_knights", "Hunt Down robber_knights", qf_random_quest,
  #"{!}{s9} of {s4} asked you to hunt down the {s10} in the vicinity of the town."
  #),
  
 #("hunted_bandits", "Hunt Down Bandits", qf_random_quest,
  #"{!}{s9} of {s4} asked you to hunt down the {s10} in the vicinity of the town."
  #),
    
 #("hunted_looters", "Hunt Down Looters", qf_random_quest,
  #"{!}{s9} of {s4} asked you to hunt down the {s10} in the vicinity of the town."
  #),
